...
AVAILABLE_DATASETS = ["trivia_qa", "gsm8k",
                      "natural_qa", "pop_qa", "simple_qa", "wikipedia_factual", "narrative_qa", "okvqa", "evqa", "infoseek"]
LONG_FORM_AVAILABLE_DATASETS = ["longfact_concepts", "longfact_objects"]

AVAILABLE_CONTEXTS_EVQA = [None, "doc+", "doc-", "bm25", "random_doc", "rerank", "eva_clip+contriever", "mixed"]
AVAILABLE_CONTEXTS_INFOSEEK = [None, "doc+", "doc-", "bm25", "random_doc", "rerank"]
