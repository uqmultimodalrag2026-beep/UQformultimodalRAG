import os
# Set the Hugging Face cache path
hf_cache_path = "/netscratch/sbinz/hf_cache"
os.environ["HF_HOME"] = hf_cache_path
os.environ["TRANSFORMERS_CACHE"] = os.environ["HF_HOME"]

output_dir = "/netscratch/sbinz/plots"
...
def load_model(model_name = "/ds/models/llms/Meta-Llama-3-8B-Instruct"):
...
def run_experiment(model, truth_methods, tokenizer):
    ...
    return_method_details = True,  batch_generation = True, 
    ...
    #print(results['output_dict']['truth_method_0'])
